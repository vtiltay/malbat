...
if not SECRET_KEY:
    raise ValueError("SECRET_KEY environment variable is required. Set it in /home/debian/dotenvs/malbat.org")
...
ROOT_URLCONF = 'malbat.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'familytree' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'malbat.wsgi.application'
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'malbathaco@gmail.com')
